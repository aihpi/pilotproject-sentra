...
class WithdrawResponse(BaseModel):
    ...
    `registered` is false when the points were removed but no registry row
    knew the filename. The caller got what it asked for either way, and the
    difference is worth reporting: it means the corpus and the registry
