...
/** What withdrawing a document did.
 *
 *  `registered` is false when the points were removed but no registry row knew
 *  the filename, which means the corpus and the registry disagree. */
